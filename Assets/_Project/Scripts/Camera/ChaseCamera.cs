...
namespace TempleSprint
{
    ...
    public class ChaseCamera : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            Vector3 offset = _localOffset + new Vector3(0f, bobY + _lookLift * 0.15f, -_pullback);
            ...
            Vector3 look = _target.position + Vector3.up * (1.15f + _lookLift * 0.35f) + _target.forward * 2.0f;
            ...
            float targetFov = _baseFov + Mathf.Clamp((speed - 10f) * 0.35f, 0f, 8f) + _punchFov + _pullback * 2f;
